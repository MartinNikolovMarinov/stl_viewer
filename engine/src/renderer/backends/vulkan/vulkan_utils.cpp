...
const char* vulkanResultToCptr(VkResult result, bool extended) {
    ...
    switch (result) {
        ...
        case VK_ERROR_DEVICE_LOST:
            return !extended ? "VK_ERROR_DEVICE_LOST" : "VK_ERROR_DEVICE_LOST The logical or physical device has been lost. See Lost Device";
        ...
        case VK_ERROR_VALIDATION_FAILED_EXT:
            return !extended ? "VK_ERROR_VALIDATION_FAILED_EXT" : "VK_ERROR_VALIDATION_FAILED_EXT A validation layer found an error.";
        case VK_ERROR_INVALID_DRM_FORMAT_MODIFIER_PLANE_LAYOUT_EXT:
            return !extended ? "VK_ERROR_INVALID_DRM_FORMAT_MODIFIER_PLANE_LAYOUT_EXT" : "VK_ERROR_INVALID_DRM_FORMAT_MODIFIER_PLANE_LAYOUT_EXT When creating a VkImage with VkImageDrmFormatModifierExplicitCreateInfoEXT, if the combination of the parameters drmFormatModifier, drmFormatModifierPlaneCount, drmFormatModifierPlaneLayouts, and flags is not compatible with the format, usage, and tiling.";
        case VK_ERROR_NOT_PERMITTED_KHR:
            return !extended ? "VK_ERROR_NOT_PERMITTED_KHR" : "VK_ERROR_NOT_PERMITTED_KHR The requested operation is not permitted.";
        case VK_RESULT_MAX_ENUM:
            return !extended ? "VK_RESULT_MAX_ENUM" : "VK_RESULT_MAX_ENUM A sentinel value used to specify that the maximum valid value of a VkResult.";
